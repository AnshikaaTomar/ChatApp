...
public class ClientTwo implements ActionListener{
    ...
    //global declaration 
    JTextField msg;
    static JPanel textArea; //to display the messages
    ...
    //Constructor
    ClientTwo(){
        fr.setTitle("SpillTheTea - Client Two");
        ...
        try{
            String userName = "User3"; // Assign a default username 
